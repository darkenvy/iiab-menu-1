...
if (typeof forceFullDisplay == 'undefined') {
  forceFullDisplay = false; // allow override in index.html
}

if (typeof dynamicHtml == 'undefined') {
  dynamicHtml = true; // allow override in index.html
}
